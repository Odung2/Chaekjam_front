...
// import 'package:best_flutter_ui_templates/write_review/components/faderoute.dart';
import 'package:best_flutter_ui_templates/fitness_app/write_review/components/faderoute.dart';
...
import 'package:best_flutter_ui_templates/fitness_app/write_review/screens/view.dart';
...
class WriteReviewHomeScreen extends StatefulWidget {
  Function(Brightness brightness) changeTheme;
  final String? title;
  // Themedata

  WriteReviewHomeScreen({Key? key, this.title, required this.changeTheme})
      : super(key: key) {
    // this.changeTheme = changeTheme;
  }
  @override
  _WriteReviewHomeScreenState createState() => _WriteReviewHomeScreenState();
}

class _WriteReviewHomeScreenState extends State<WriteReviewHomeScreen> {
  bool isFlagOn = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: Text('새 리뷰 추가하기 🍀'.toUpperCase()),
        icon: Icon(Icons.add),
      ),
        ...
        children: <Widget>[
          GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              child: Icon(
                isFlagOn ? Icons.flag : FluentIcons.settings_16_filled,
